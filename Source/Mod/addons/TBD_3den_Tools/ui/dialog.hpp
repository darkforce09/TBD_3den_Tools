class TBD_Library_Dialog 
{
    ...
    class ControlsBackground 
    {
        ...
        class MainBg: RscText {
            idc = -1;
            x = "safezoneX + 0.2 * safezoneW"; y = "safezoneY + 0.2 * safezoneH";
            w = "0.6 * safezoneW"; h = "0.6 * safezoneH";
        ...
        class HeaderBg: RscText {
            idc = -1;
            x = "safezoneX + 0.2 * safezoneW"; y = "safezoneY + 0.2 * safezoneH";
            w = "0.6 * safezoneW"; h = "0.04 * safezoneH";
        ...
        class FooterBg: RscText {
            idc = -1;
            x = "safezoneX + 0.2 * safezoneW"; y = "safezoneY + 0.75 * safezoneH";
            w = "0.6 * safezoneW"; h = "0.05 * safezoneH";
    ...
    class Controls 
    {
        ...
        class Title: RscText {
            ...
            x = "safezoneX + 0.205 * safezoneW"; 
            y = "safezoneY + 0.2 * safezoneH";
            w = "0.6 * safezoneW - 0.04 * safezoneH";
            h = "0.04 * safezoneH";
        ...
        class CloseBtn: RscButton {
            ...
            x = "safezoneX + 0.795 * safezoneW - 0.032 * safezoneH"; 
            y = "safezoneY + 0.204 * safezoneH";             
            w = "0.032 * safezoneH"; h = "0.032 * safezoneH";
        ...
        class NewFolderVisual: RscStructuredText {
            ...
            y = "safezoneY + 0.24 * safezoneH + (0.06 * safezoneH - 0.05)/2";
        ...
        class FileTree: RscTree {
            idc = 101;
            x = "safezoneX + 0.205 * safezoneW";
            y = "safezoneY + 0.3 * safezoneH + 0.005 * safezoneW";
            w = "0.3525 * safezoneW";
            h = "0.45 * safezoneH - 0.01 * safezoneW";
            colorBackground[] = COL_BG_LIGHT;
        ...
        class DetailsTitle: RscText {
            ...
            x = "safezoneX + 0.5675 * safezoneW";
            y = "safezoneY + 0.3 * safezoneH + 0.01 * safezoneW";
            w = "0.225 * safezoneW";
            h = 0.04;
            colorText[] = {1,1,1,1};
            shadow = 0;
        ...
        class DetailsNameLabel: RscText {
            ...
            x = "safezoneX + 0.5675 * safezoneW";
            y = "safezoneY + 0.3 * safezoneH + 0.01 * safezoneW + 0.05";
            w = "0.225 * safezoneW";
            h = 0.025;
        ...
        class DetailsNameEdit: RscEdit {
            idc = 106;
            x = "safezoneX + 0.5675 * safezoneW";
            y = "safezoneY + 0.3 * safezoneH + 0.01 * safezoneW + 0.08";
            w = "0.225 * safezoneW";
            h = 0.035;
        ...
        class DetailsGroup: RscStructuredText {
            idc = 105;
            x = "safezoneX + 0.5675 * safezoneW";
            y = "safezoneY + 0.3 * safezoneH + 0.01 * safezoneW + 0.13";
            w = "0.225 * safezoneW";
            h = "0.45 * safezoneH - 0.02 * safezoneW - 0.13";
            colorBackground[] = {0,0,0,0};
            text = "";
        };
        ...
        class LabelName: RscText {
            ...
            x = "safezoneX + 0.205 * safezoneW";
            y = "safezoneY + 0.775 * safezoneH - 0.02";
            w = "0.12 * safezoneW";
            h = 0.04;
